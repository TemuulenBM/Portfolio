...
const experiences: Experience[] = [
  {
    id: 1,
    company: "GCM / MoveMongolia",
    role: "Full-Stack Developer",
    duration: "2024 - Present",
    achievements: [
      "Collaborated with senior developers on enterprise-level fitness measurement system",
      "Developed feature-based architecture modules (auth, measurements, surveys, reports)",
      "Implemented assessment calculation system for physical test scoring",
      "Built activity logging and session management features",
      "Worked with Prisma ORM, PostgreSQL, and TypeScript",
    ],
    tech: ["React", "Node.js", "TypeScript", "Prisma", "PostgreSQL", "Express"],
  },
  {
    id: 2,
    ...
    duration: "2024",
    achievements: [
      "Converted legacy Python bot to modern BB8 enterprise system (67+ commands, RBAC)",
      "Built MiniMood Kids e-commerce platform with SKU-level inventory management",
      "Developed Freelance Client Portal with white-label branding and file approval workflow",
      "Created modern portfolio website with cyberpunk design and animations",
    ],
